...
public class RemoveElement_27{
   ...
   public static void main(String[] args) {
       ...
       System.out.println(solution.removeElement(new int[]{1,2,3,4,4,5,6},4));
       System.out.println(solution.removeElement(new int[]{1,1,3,4,4,5,6},1));
   }
